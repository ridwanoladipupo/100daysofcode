# Revisiting function
# Challenge: Given an interger array arrayList of n elements and a search_value,
# write a function to search the value in arrayList. If search_value exists, then returnits index, otherwise return -1 
